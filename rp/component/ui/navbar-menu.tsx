...
export const NavItems = ({ items, className, onItemClick }: NavItemsProps) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "absolute inset-0 hidden flex-1 flex-row items-center justify-center space-x-2 font-semibold racking-widest text-sm  text-center text-zinc-600 transition duration-200 hover:text-zinc-800 lg:flex lg:space-x-6",
        className,
      )}
    >
      {items.map((item, idx) => (
...
export const NavbarLogo = () => {
  return (
    ...
    >
      ...
      <span className="font-medium text-black dark:text-white">RAILWAY</span>
    </a>
  );
};
